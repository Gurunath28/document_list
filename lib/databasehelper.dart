class DatabaseHelper {
  ...
  Future _onCreate(DatabaseHelper database, int version) async {
  ...
  _onUpgrade(DatabaseHelper database, int oldVersion, int newVersion) async {
