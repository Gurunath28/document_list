...
import 'package:document_list/databasehelper.dart';
import 'package:document_list/main.dart';
import 'package:document_list/personal_list_modal.dart';
import 'package:flutter/material.dart';

class PersonNameListScreen extends StatefulWidget {
  const PersonNameListScreen({super.key});
...
class _PersonNameListScreenState extends State<PersonNameListScreen> {
  ...
  getAllPersonNameList() async{
    ...
    if(person == null){
      ...
      person.forEach((row){
        ...
        var personNameModel = PersonNameListModel(row['_id'], row['person_name']);
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:ListView.builder(itemCount:_personNameList.length, itemBuilder:(context,index){
          ...
          child: Card(
            ...
            child: ListTile(
              ...
              title: Row(
                ...
                children:<Widget>[
                  Text(_personNameList[index].id.personName),
